...
public:
	...
	DWORD Write(const char *szBuffer,int size)
	{
		CN_ASSERT(szBuffer);
		
		return Write((LPCVOID)szBuffer, size);
	}
...
protected:
	...
	virtual bool SetupPort()
	{
		...
		CO_.ReadTotalTimeoutMultiplier	= 50;
		//CO_.ReadTotalTimeoutConstant	= IsOverlappedMode() ? 500 : 250;//! 读超时 重叠I/O模式下500毫秒 阻塞I/O模式下250毫秒
		CO_.ReadTotalTimeoutConstant	= 5000;//! 读超时 重叠I/O模式下500毫秒 阻塞I/O模式下250毫秒
